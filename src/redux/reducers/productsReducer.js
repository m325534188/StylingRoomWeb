...
const initialState = [
    ...
    { id: 6, name: "אגרטל פרחים דקורטיבי עגול ", qty: 120,qtyCart:0, image: img6, price: 70, description: "זוג אגרטלים זכוכית" },
    ...
    { id: 15, name: " אגרטל אייס" ,qty: 50,qtyCart:0, image: img15, price: 150, description: "קישוט שולחן, עיצוב ייחודי" },
